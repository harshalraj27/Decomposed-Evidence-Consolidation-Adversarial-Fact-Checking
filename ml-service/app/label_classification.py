...
health_regex = re.compile(r"\b(vaccine|covid|virus|disease|infection|drug|antibiotic|cancer|therapy|symptom)\b", re.I)
...
def classify(sentence, top_label=None, top_score=None, second_label=None, second_score=None, THRESHOLD = 0.45):
    ...
    if health_regex.search(sentence):
